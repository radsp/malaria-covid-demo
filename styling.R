...
pcnt_overlay_clr <- c("reports_rate" = clr_report, 
                      "residential"  = "#fbb4ae", "workplaces"  = "#b3cde3",
                      "grocery and pharmacy" = "#8dd3c7", "retail and recreation" = "#7fc97f",
                      "transit stations" = "#fdc086", "parks" = "#ffff99")

mobility_clr <- pcnt_overlay_clr[-1]
names(mobility_clr) <- str_to_sentence(names(mobility_clr))
