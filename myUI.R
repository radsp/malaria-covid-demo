             ...
             tabPanel("Changes In Indicator",
                      ...
                      sidebarLayout(
                        sidebarPanel(width = 2,
                                     ...
                                     br(),
                                     selectInput(inputId = "in_yr0_snap", label = "Select year to compare:", choices = c(rev(2016:2019), "Historical mean"), 
                                                 selected = "2019")
                        ),
                        mainPanel(
                          ...
                          fluidRow(style = 'padding-left:10px;',
                                   plotOutput("out_plot_pcnt"), setBackgroundColor("white")))
                      )),
...
#   navbarMenu("Rainfall",
#              
#              tabPanel("National Level/Subnational", # theme = "bootstrap_simplex.css",
#                       
#                       tags$style(type = "text/css", "#out_rfplot_adm0 {height: calc(100vh - 150px) !important;}"),
#                       
#                       fluidPage(
