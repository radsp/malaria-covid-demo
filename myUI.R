                        ...
                        sidebarLayout(
                          div(id = "sidebar_mal_adm0", 
                              sidebarPanel(width = 2,
                                           ...
                                           br(),
                                           selectInput(inputId = "in_yr0_mal_adm0", label = "Select year to compare:", choices = c(rev(2016:2019), "Long-term mean"), 
                        ...
                        fluidRow(
                          ...
                          column(8, p(HTML("KEY ANALYTICAL QUESTIONS:")),
                                 tags$ol(
                                   ...
                                   tags$li("What is the forecasted COVID-19 trajectory and how is the timing coincide with malaria season or any intervention measures?"),
                          ...
                          div(id = "sidebar_mal_adm1", 
                              sidebarPanel(width = 2,
                                           ...
                                           prettyRadioButtons(inputId = "in_radio_include_adm1", label = HTML("Include:"),
                                                              choices = c("COVID-19 Forecasts", "Reporting Rate (not implemented yet)", "None"), inline = FALSE,
                                                              fill = FALSE, status = "default"),
                                           hr(),
                                           h5(HTML("<b>Calculate 2020 Data Difference</b>")),
                                           br(),
                                           selectInput(inputId = "in_yr0_mal_adm1", label = "Select year to compare:", choices = c(rev(2016:2019), "Long-term mean"), selected = "Long-term mean"),
                                           fluidRow(column(6,
             ...
             tabPanel("National Level", theme = "bootstrap_simplex.css",
                      ...
                      fluidPage(
                        ...
                        fluidRow(
                          sidebarLayout(
                            sidebarPanel(width = 2,
                                         selectInput(inputId = "in_region_rf_adm0", label = "Region:",
                                                     choices = c("All Countries", "Northern Hemisphere", "Southern Hemisphere",
                                                                 "Western Africa", "Eastern Africa", "Central/Southern Africa",  "Southeast Asia")),
                                         selectInput(inputId = "in_totcumu_rf_adm0", label = "Display rainfall as:", 
                                                     choices = c("Monthly Total", "Accumulated")),
                                         uiOutput(outputId = "out_acc_period_rf_adm0"),
                                         hr(),
                                         h5(HTML("<b>Display malaria indicator / COVID-19 cases</b>")),
                                         br(),
                                         ...
                                         prettyRadioButtons(inputId = "in_yaxs_rf_adm0",
                                                            label = HTML("Display indicator as:"), choices = c("Cases per 1000 population" = "rate", "Cases" = "count"),
                                                            inline = FALSE, status = "default")
